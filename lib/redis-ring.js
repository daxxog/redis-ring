...
(function (root, factory) {
    ...
    var RedisRing = function(ring, options, auth) {
        ...
        ring.forEach(function(v, i, a) {
            ...
            var _id = clientSpawners.push(((function(_port, _host) {
                var port = _port,
                    host = _host;
                return function() {
        ...
        this._cmd = function(cmd, args) {
            _proto[cmd].apply(clients[that.hashRing.get(_prefix + args[0])], args);
        };
        ...
        this.spawnClient = function(key) {
            return clientSpawners[that.hashRing.get(_prefix + key)]();
        };
